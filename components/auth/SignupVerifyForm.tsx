...
export default function SignupVerifyForm(): React.ReactNode {
    ...
    // 验证邮箱验证码
    async function onClickVerify(event: React.FormEvent<HTMLFormElement>) {
    ...
    return (
        <div className="w-full p-10 bg-white rounded-lg shadow-lg">
            ...
            <form className="space-y-5 mt-6" onSubmit={onClickVerify}>
                <TextField
                ...
                <div>
                    ...
                    <button type='button'
                        onClick={resendCode}
                        className="flex justify-center items-center w-full h-12 py-2 px-4 bg-primary-100 hover:bg-gray-200 text-gray-500 rounded-lg text-base">
                        Resend Code
                        <CircularProgress sx={{ color: 'gre', ml: 1 }} size={20} thickness={5}
